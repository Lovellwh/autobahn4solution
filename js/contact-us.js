...
form.addEventListener("submit", (e) => {
  ...
  var name = formData.get("entry.26750290");
  var email = formData.get("entry.689377870");
  var phoneNumber = formData.get("entry.5638127");
  var message = formData.get("entry.1442112578");
  ...
  if ((!phoneNumberRegex.test(phoneNumber)) || ((phoneNumber.length) < 10)) {
    alert("Please enter valid phone number of minimum 10 digit number");
    return false;
  }
